...
import { Upload, message, Form, Input, Button, PageHeader } from "antd";
...
//使用beforeUpload限制用户上传的图片格式和大小，beforeUpload的返回值可以是一个Promise以支持异步处理，如服务端校验等
